...
public class QsTaskScheduler {
    ...
    @SchedulerLock(name = "weeklyTimeslotCleanup", lockAtLeastFor = "PT5M", lockAtMostFor = "PT10M")
...
//    @Scheduled(cron = "0 */1 * * * *")
//    @SchedulerLock(name = "weeklyTimeslotCleanupTest", lockAtLeastFor = "PT5M", lockAtMostFor = "PT10M")
//    public void test() {
//        // Publish the task message to Kafka
//        var ctr = new CleanupTimeslotsRequest();
//        var today = LocalDate.now();
